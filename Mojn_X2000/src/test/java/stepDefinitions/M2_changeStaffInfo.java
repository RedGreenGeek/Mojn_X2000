...
public class M2_changeStaffInfo {
	...
	public void i_am_an_ICT_officer() {
		api.registerStaff("admin","I","Nurse", "Erika", "Eriksen", "NurseRoad", "Humanist", 13, 5, 1990);
		api.staffSearcher("admin","I","", "Erika", "Eriksen", "", "");
	}
	
	@When("^I am entering sufficient search data$")
	public void i_am_entering_sufficient_search_data() {
		message = api.staffSearcher("admin","I","", "Lars", "", "", "");
	...
	public void i_can_change_the_wanted_parameters_to_something_valid() {
		message = api.changeStaff ("admin","I","D2" ,"" ,"LARS", "LYKKE","Venstre", "", 0, 0, 0);
	...
	public void i_am_entering_insufficient_search_data() {
		...
		message = api.changeStaff("admin","I","J192" ,"" ,"", "","", "", 0, 0, 0);	
	...
	public void i_try_invalid_changes_on_a_staff() {
		...
		message = api.changeStaff("admin","I","" ,"" ,"Lars", "Lykke","", "", 45, 2, 1971);	
	}
	...
	public void i_am_entering_sufficient_data_but_no_job_type() {
		message = api.changeStaff("admin","I","N3" ,"" ,"Jonna", "Nielsen","Ikke-doktorvej", "Tysk", 02,02, 1902);
	}
	...
	public void i_am_entering_sufficient_data_with_jobtype() {
		message = api.changeStaff("admin","I","N3" ,"Doctor" ,"Jonna", "Nielsen","Ikke-doktorvej", "Tysk", 02,02, 1902);
	}
