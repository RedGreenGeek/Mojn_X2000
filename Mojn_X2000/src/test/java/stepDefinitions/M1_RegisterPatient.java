...
public class M1_RegisterPatient {
	...
	public void i_am_entering_sufficient_patient_data() {
		...
		message = api.registerPatient("admin","I",firstName, lastName, tribe, address, day, month, year, alive);
	...
	public void i_am_not_entering_lastname() {	
		message = api.registerPatient("admin","I",firstName, "", tribe, address, day, month, year, alive);
	}

	@When("^I am not entering first name$")
	public void i_am_not_entering_first_name() {
		message = api.registerPatient("admin","I","", lastName, tribe, address, day, month, year, alive);
	}

	@When("^I am not entering adress$")
	public void i_am_not_entering_adress() {
		message = api.registerPatient("admin","I",firstName, lastName, tribe, "", day, month, year, alive);
	}

	@When("^I am not entering tribe$")
	public void i_am_not_entering_tribe() {
		message = api.registerPatient("admin","I",firstName, lastName, "", address, day, month, year, alive);
	}

	@When("^I am entering birthday wrongly$")
	public void i_am_entering_birthday_wrongly() {
		message = api.registerPatient("admin","I",firstName, lastName, tribe, address, 32, month, year, alive);
	}
