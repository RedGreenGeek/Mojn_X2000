...
public class M4_PatientAdmission {
	...
	public void i_am_entering_a_existing_In_depart() {
		...
		String trilvl = "";
		message = api.patientAdmission("I","I",trilvl, departmentName, "2");
	}
	...
	public void i_am_entering_a_existing_Out_depart() {
		...
		String trilvl = "2";
		message = api.patientAdmission("I","I",trilvl, department, "1");
	}
	...
	public void i_am_entering_a_wrong_Admin_depart() {
		...
		String trilvl = "";
		message = api.patientAdmission("I","I",trilvl, department,"4");
	}
	...
	public void i_am_entering_a_wrong_trilvl() {
		...
		String trilvl = "wer";
		message = api.patientAdmission("I","I",trilvl, department,"5");
	}
	...
	public void i_am_entering_a_wrong_Person_value() {
		String department = "ER";
		String trilvl = "";
		message = api.patientAdmission("I","I",trilvl, department,"4243");
	}
	...
	public void i_am_entering_a_wrong_invalid_depart() {
		...
		String trilvl = "";
		message = api.patientAdmission("I","I",trilvl, department,"2");
	}
