...
public class O5_participationList {
	...
	@Then("^I get a pdf containing information of all patients$")
	public void i_get_a_pdf_containing_information_of_all_patients() throws IOException {
	...
	@Then("^I get a pdf containing information of patients from that department$")
	public void i_get_a_pdf_containing_information_of_patients_from_that_department() throws IOException {
