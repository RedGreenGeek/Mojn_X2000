...
public class M2_staffRegistration {
	...
	public void i_am_entering_sufficient_clerk_data() {
		user_message = api.registerStaff ("admin","I","Clerk" ,"Lars", "Larsen", "Silkeborg", "Jysk billionær", 1, 1, 666);
	}
	...
	public void i_am_entering_sufficient_nurse_data() {
		user_message = api.registerStaff ("admin","I","Nurse" ,"Lars", "Larsen", "Silkeborg", "Jysk billionær", 1, 1, 666);
	}
	...
	public void i_am_entering_sufficient_doctor_data() {
		user_message = api.registerStaff ("admin","I","Doctor" ,"Lars", "Larsen", "Silkeborg", "Jysk billionær", 1, 1, 666);
	}
	...
	public void i_am_entering_sufficient_ictofficer_data() throws Throwable {
		user_message = api.registerStaff ("admin","I","ICTOfficer" ,"Lars", "Larsen", "Silkeborg", "Jysk billionær", 1, 1, 666);
	}
	...
	public void i_am_entering_insufficient_staff_data() {
		user_message = api.registerStaff ("admin","I","Nurse" ,"Lars", "", "Silkeborg", "Jysk billionær", 1, 1, 666);
		user_message2 = user_message = api.registerStaff ("admin","I","Kromutter" ,"Lars", "Larsen", "Silkeborg", "Jysk billionær", 1, 1, 666);
	}
